...
$url = "https://leads.quotestorm.co/new_api/api.php?Key=Vq3pEiHOEtAGu-s9m-dTVfe1VRNNmfAiufEGuRmqV_ENkP3pmP2lcPDo&API_Action=getLeadDetails&Format=JSON";

$leadid = $_POST['leadid'];

$url = $url.'&Lead_ID='.$leadid.'&Lead_Type=23';
