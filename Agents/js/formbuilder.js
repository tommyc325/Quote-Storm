...
var form4info = [
{
  ...
  "formhtml":'<div class="alert alert-warning">Lead must be submitted within 1 (one) business hour of receipt for refund approval. Please answer the additional questions below.</div>',
